                ...
                <section class="content__left col-md-8">
                  <div class="block">
                    ...
                    <div class="block__content">
                      ...
                      <div class="full-text">
                      Запрашиаемая статья не существует
                      </div>
                    </div>
                  </div>
                ...
                <div id="#comment-add-form" class="block">
                  ...
                  <div class="block__content">
                    ...
                    if (isset ($_POST['do_post']))
                    {
                      ...
                      if ( $_POST['text'] == '' )
                      {
                        $errors[] = 'ВВедите Текст коммента!';
                      }
                         if ( empty($errors) )
                         {
                          mysqli_query( $comments, "INSERT INTO `comments` ('autor', 'nickname', 'text', 'pubdate', 'articles_id') VALUES ('".$_POST['name']."', '".$_POST['nickname']."', '".$_POST['text']."', NOW(), '".$art['id']."')");
