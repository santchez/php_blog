    ...
    <div id="content">
      <div class="container">
          ...
          ?>
           <article class="article">
                    ...
                    <div class="article__info">
                      ...
                      <div class="article__info__preview"><?php echo mb_substr($art['text'], 0, 75, 'utf-8') . ' ...'; ?></div>
                    </div>
                  </article>
          <?php
        }
        ...
        if ( $articles_exist == false )
        {
          ...
          if ( $page < $total_pages )
          {
          echo '<a href="/articles.php?page='.($page + 1).'">Вперед</a>';
          }
          echo '</div>';
        }
        ?><p style="color: #ccc;">Тут будет навигация по страницам</p><br> <a href="#">&laquo; Назад</a>   <a href="#">Вперед &raquo;</a>
              </div>
            </div>
